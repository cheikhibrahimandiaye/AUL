...
const translations = {
  fr: {
    ...
    hero_tag: "African University League",
    hero_title: "L'Avenir du Sport Universitaire Africain",
    hero_desc: "L'AUL redéfinit le sport universitaire en Afrique — compétition d'élite, scouting, innovation et opportunités pour les athlètes-étudiants du continent.",
    hero_cta: "Découvrir la Saison 2027",
    hero_secondary: "Voir les actualités →",
    hero_season: "Saison 2027",
    ticker_label: "Résultats",
    news_title: "Actualités",
    news_more: "Tout voir",
    standings_title: "Classement",
    standings_season: "AUFL · Saison 2027 · Football",
    ...
    cta_tag: "Rejoignez l'AUL",
    cta_title: "Bâtissons l'Avenir du Sport Universitaire Africain",
    cta_desc: "L'AUL ouvre ses portes aux universités africaines qui partagent notre vision : élever les standards, révéler les talents et créer des trajectoires vers le haut niveau. Candidatures ouvertes pour la saison 2027.",
    ...
    footer_faq: "FAQ",
    page_calendar_label: "Saison 2027",
    page_calendar_title: "Calendrier",
    page_calendar_subtitle: "Tous les matchs AUFL de la saison 2027 — phases de groupes, demi-finales et finale.",
    page_standings_label: "Saison 2027",
    page_standings_title: "Classement",
    page_news_label: "Médias & Actualités",
    page_news_title: "Actualités",
    page_universities_label: "Saison 2027",
    page_universities_title: "Universités",
    page_about_label: "Notre Mission",
    page_about_title: "À Propos de l'AUL",
    page_contact_label: "Rejoignez l'AUL",
  ...
  en: {
    ...
    hero_desc: "The AUL is redefining university sport across Africa — elite competition, scouting, innovation, and real opportunities for student-athletes across the continent.",
    hero_cta: "Explore the 2027 Season",
    hero_secondary: "View news →",
    hero_season: "Season 2027",
    ticker_label: "Results",
    news_title: "Latest News",
    news_more: "View all",
    standings_title: "Standings",
    standings_season: "AUFL · Season 2027 · Football",
    ...
    cta_tag: "Join the AUL",
    cta_title: "Build the Future of African University Sport",
    cta_desc: "The AUL is open to African universities that share our vision: raising standards, uncovering talent, and creating pathways to the next level. Applications open for the 2027 season.",
    ...
    footer_faq: "FAQ",
    page_calendar_label: "Season 2027",
    page_calendar_title: "Schedule",
    page_calendar_subtitle: "All AUFL 2027 season fixtures — group stage, semi-finals and final.",
    page_standings_label: "Season 2027",
    page_standings_title: "Standings",
    page_news_label: "Media & News",
    page_news_title: "News",
    page_universities_label: "Season 2027",
    page_universities_title: "Universities",
    page_about_label: "Our Mission",
    page_about_title: "About AUL",
