...
const translations = {
  fr: {
    ...
    standings_season: "AUFL · Saison 2026 · Football",
    ...
    page_calendar_subtitle: "Tous les matchs AUFL de la saison 2026 — phases de groupes, demi-finales et finale.",
  ...
  en: {
    ...
    standings_season: "AUFL · Season 2026 · Football",
    ...
    page_calendar_subtitle: "All AUFL 2026 season fixtures — group stage, semi-finals and final.",
