...
export const LEAGUES: League[] = [
  {
    ...
    description: "8 universités, 5 pays, une seule championne. L'AUFL porte le football universitaire africain vers l'excellence internationale.",
    description_en: "8 universities, 5 countries, one champion. AUFL elevates African university football to international excellence.",
    ...
    available: true,
    standings: [
      { rank: 1, university: "Univ. de Dakar",   wins: 14, losses: 2 },
      { rank: 2, university: "Univ. de Nairobi", wins: 12, losses: 4 },
      { rank: 3, university: "Univ. du Caire",   wins: 11, losses: 5 },
      { rank: 4, university: "Univ. de Lagos",   wins: 10, losses: 6 },
      { rank: 5, university: "Univ. d'Accra",    wins: 9,  losses: 7 },
      { rank: 6, university: "Univ. de Tunis",   wins: 8,  losses: 8 },
    ],
    matches: [
      { id: "1", date: "20", day: "Mai", homeTeam: "Univ. de Dakar",  awayTeam: "Univ. de Nairobi", time: "18:00", venue: "Stade L.S. Senghor",         round: "Demi-finale 1" },
      { id: "2", date: "20", day: "Mai", homeTeam: "Univ. du Caire",  awayTeam: "Univ. de Lagos",   time: "21:00", venue: "Cairo International Stadium",  round: "Demi-finale 2" },
      { id: "3", date: "23", day: "Mai", homeTeam: "Univ. d'Accra",   awayTeam: "Univ. de Tunis",   time: "19:00", venue: "Accra Sports Stadium",         round: "Demi-finale 3" },
      { id: "4", date: "25", day: "Mai", homeTeam: "TBD",             awayTeam: "TBD",              time: "20:00", venue: "Kigali Pelé Stadium",          round: "Finale", isHighlight: true },
    ],
    videos: [
